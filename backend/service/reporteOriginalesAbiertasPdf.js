...
<body>
  ...
  <div class="total-clientes">Total de Órdenes: ${data.total}</div>
...
async function streamReporteOriginalesAbiertasPdf(res, data, desde, hasta, asesor) {
  ...
  res.setHeader('Content-Disposition', 'inline; filename="reporte_originales_abiertas.pdf"');
  res.send(pdfBuffer);
}

module.exports = { streamReporteOriginalesAbiertasPdf };
