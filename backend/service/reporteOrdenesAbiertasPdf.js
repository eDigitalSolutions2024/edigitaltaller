        ...
        <table class="data">
          ...
          <tfoot>
            <tr class="subtotal-row">
              <td colspan="10" style="font-style:italic; font-weight:bold;">Total de Órdenes: ${grupo.ordenes.length}</td>
            </tr>
          </tfoot>
        </table>`;
    })
...
<body>
  ...
  <div class="titulo-row">
    <div class="titulo">Reporte de Órdenes Abiertas</div>
    <div class="fechas">
  ...
  <div class="gran-total">
    Total General de Órdenes Abiertas: ${resultado.totalOrdenes}
  </div>
...
async function streamReporteOrdenesAbiertasPdf(res, resultado, desde, hasta) {
  ...
  res.setHeader('Content-Disposition', 'inline; filename="reporte_ordenes_abiertas.pdf"');
  res.send(pdfBuffer);
}

module.exports = { streamReporteOrdenesAbiertasPdf };
